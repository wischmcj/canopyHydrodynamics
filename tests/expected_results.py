...
ten_cyls_flows = "[Flow(num_cylinders=10, projected_area=1.1403634048673046, surface_area=3.3102009951007805, angle_sum=13.311017528987755, volume=0.327783, sa_to_vol=100.98563451833446, drip_node_id=0)]"
...
small_tree_flows = "[Flow(num_cylinders=216, projected_area=9.548304765079342, surface_area=19.49507498855058, angle_sum=180.03288665020412, volume=3.9062959999999998, sa_to_vol=83646.4965224844, drip_node_id=0), Flow(num_cylinders=59, projected_area=0.017645405715860037, surface_area=0.0653136170203522, angle_sum=4.0063304619261375, volume=7.699999999999999e-05, sa_to_vol=52984.87647431056, drip_node_id=405.0), Flow(num_cylinders=32, projected_area=0.009907274543278253, surface_area=0.03666120817014779, angle_sum=3.2693589141152817, volume=4.8e-05, sa_to_vol=25387.06100800808, drip_node_id=222.0), Flow(num_cylinders=4, projected_area=0.0016017985358579676, surface_area=0.006360028663486393, angle_sum=-1.4004883938106008, volume=7e-06, sa_to_vol=inf, drip_node_id=188.0), Flow(num_cylinders=8, projected_area=0.0021650296171883427, surface_area=0.008355741104642577, angle_sum=-2.5182426363497505, volume=9.999999999999999e-06, sa_to_vol=6887.50207002412, drip_node_id=147.0), Flow(num_cylinders=6, projected_area=0.0017991180211844031, surface_area=0.005825910788486325, angle_sum=-2.115709206226209, volume=5.999999999999999e-06, sa_to_vol=5825.910788486325, drip_node_id=163.0), Flow(num_cylinders=3, projected_area=0.0006730961405245622, surface_area=0.003272345739832201, angle_sum=0.3639153227121651, volume=4e-06, sa_to_vol=2617.2529857240233, drip_node_id=176.0), Flow(num_cylinders=5, projected_area=0.001500743025583203, surface_area=0.00503121351083425, angle_sum=-0.00046949725728318015, volume=7e-06, sa_to_vol=3582.900027621186, drip_node_id=179.0), Flow(num_cylinders=1, projected_area=0.00020956168877595788, surface_area=0.0009704536786571552, angle_sum=-0.525305433679695, volume=1e-06, sa_to_vol=970.4536786571553, drip_node_id=226.0), Flow(num_cylinders=35, projected_area=0.012142571757200769, surface_area=0.0436400206306485, angle_sum=10.193206366817037, volume=5.299999999999999e-05, sa_to_vol=inf, drip_node_id=232.0), Flow(num_cylinders=3, projected_area=0.0006941438530039307, surface_area=0.0030501880153335982, angle_sum=-1.0835316994580007, volume=4e-06, sa_to_vol=2407.4260123907607, drip_node_id=274.0), Flow(num_cylinders=24, projected_area=0.007046870448618746, surface_area=0.02719439569967338, angle_sum=-0.467953573105651, volume=3.4e-05, sa_to_vol=20303.90126264672, drip_node_id=350.0), Flow(num_cylinders=5, projected_area=0.0014946769905439061, surface_area=0.005638373415030282, angle_sum=-2.4195862206414995, volume=7e-06, sa_to_vol=4248.493555173988, drip_node_id=309.0), Flow(num_cylinders=2, projected_area=0.0009623007673040992, surface_area=0.003129183362608114, angle_sum=-1.7050548651799198, volume=3e-06, sa_to_vol=2136.118070826746, drip_node_id=304.0), Flow(num_cylinders=5, projected_area=0.001956609023203459, surface_area=0.006314459862046074, angle_sum=-4.00094773716074, volume=6.999999999999999e-06, sa_to_vol=inf, drip_node_id=321.0), Flow(num_cylinders=3, projected_area=0.0008041777564688303, surface_area=0.0036045534549860535, angle_sum=0.5863978722482486, volume=4e-06, sa_to_vol=2774.929521007695, drip_node_id=315.0), Flow(num_cylinders=3, projected_area=0.0006688308398514381, surface_area=0.0030539265105913706, angle_sum=-1.3293928778054518, volume=4e-06, sa_to_vol=2395.079553262153, drip_node_id=325.0), Flow(num_cylinders=103, projected_area=0.03379451402012723, surface_area=0.1308078996954519, angle_sum=0.9595299834971135, volume=0.000184, sa_to_vol=81927.57367017229, drip_node_id=513.0)]"
